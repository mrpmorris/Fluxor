using Fluxor;
using BasicConcepts.EffectsSample.Client.Store.WeatherUseCase;
using BasicConcepts.EffectsSample.Shared;
using BasicConcepts.EffectsSample.Store.CounterUseCase;
using System;
using System.Linq;

namespace BasicConcepts.EffectsSample
{
	public class App
	{
