namespace Fluxor.StoreBuilderSourceGeneratorTests
{
	...
	internal class TestState3Action1 { }

	internal class TestState3Action1Reducer : Reducer<TestState3, TestState1Action1>
	{
		public override TestState3 Reduce(TestState3 state, TestState1Action1 action) => state;
	}
