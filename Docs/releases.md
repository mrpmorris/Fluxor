...
* **Breaking change**: `UseReduxDevTools` no longer requires Newtonsoft ([#360](https://github.com/mrpmorris/Fluxor/issues/360))
*  Support Action Filtering in Redux Dev Tools ([#386](https://github.com/mrpmorris/Fluxor/issues/386))
